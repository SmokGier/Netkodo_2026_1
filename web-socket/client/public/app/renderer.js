...
cable.subscriptions.create(CHANNEL_NAME, {
  ...
  disconnected() { statusEl.textContent = "⚠️ Rozłączono"; statusEl.className = "error"; log("Rozłączono", "error"); },
  rejected() { statusEl.textContent = "❌ Błąd połączenia"; statusEl.className = "error"; log("Subskrypcja odrzucona", "error"); },
  received(data) {
